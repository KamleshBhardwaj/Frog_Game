...
Original file is located at
    https://colab.research.google.com/drive/1mgIFKYI2sLZA_77lUc-Z-xe9UbntlgM4
...
### your code here
def valid_move(selected_position, current_position, positions):
    # Condition 1
    ...
    # Condition 2
    elif selected_position + 2 <= 6 and positions[current_position + 2] == '-' and positions[selected_position + 1] == 'B':
...
### your code here
def valid_move_2(selected_position, current_position, positions):
    # Condition 1
    ...
    # Condition 2
    elif selected_position - 2 >= 0 and positions[current_position - 2] == '-' and positions[selected_position - 1] == 'G':
        pos2 = selected_position - 2
        return pos2
...
### your code here
def swap(selected_position, pos2, positions):
    if pos2 is not None:
...
### your code here
def display_game(pos2):
    print("  ".join(map(str, range(len(pos2)))))
    print(pos2)
...
def check_winning_condition(positions):
    ...
    winning_condition = ['B', 'B', 'B', '-', 'G', 'G', 'G']

    if pos2 == winning_condition:
        print("You Win!")
